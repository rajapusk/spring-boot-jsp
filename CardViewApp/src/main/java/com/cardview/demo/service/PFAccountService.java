...
public class PFAccountService {
	...
	public PFAccountEntity getAllPFAccountViewById(long id) throws ClassNotFoundException, SQLException {
		List<PFAccountEntity> emplicList = new ArrayList<PFAccountEntity>();
		Class.forName("com.mysql.jdbc.Driver");
		Connection dbConnection = DriverManager.getConnection(driverUrl, userName,password);
		Statement getFromDb = dbConnection.createStatement();
	...
	public List<PFAccountEntity> getAllPFAccountViewByIds(String ids) throws ClassNotFoundException, SQLException {
		List<PFAccountEntity> emplicList = new ArrayList<PFAccountEntity>();
		Class.forName("com.mysql.jdbc.Driver");
		Connection dbConnection = DriverManager.getConnection(driverUrl, userName,password);
		Statement getFromDb = dbConnection.createStatement();
