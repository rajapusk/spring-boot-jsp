var Loan = function(){
	...
	var columns =  [
      ...
      { text: 'PF Balance', datafield: 'pfBalance', width: 80, editable: false, cellsalign: 'right', renderer: Common.numberIconHeader },
      { text: 'Interest', datafield: 'interest', width: 80, editable: false, cellsalign: 'right', renderer: Common.numberIconHeader },
      { text: 'Required Amount', datafield: 'requiredAmount', editable: false, width: 110, cellsalign: 'right', renderer: Common.numberIconHeader },
      { text: 'Rate Of Interest', datafield: 'rateOfInterest', editable: false, width: 100, cellsalign: 'right' },
      { text: 'EMI Amount', datafield: 'emiAmount', width: 100, editable: false, cellsalign: 'right', renderer: Common.numberIconHeader },      
      { text: 'No Of EMI', datafield: 'noOfEMI', width: 100, editable: false, cellsalign: 'right'},      
      { text: 'Prev Net Salary', datafield: 'prevNetSalary', editable: false, width: 100, cellsalign: 'left', renderer: Common.numberIconHeader},
      { text: 'Prev Net Salary Percetage', datafield: 'netSalaryPercentage', editable: false, width: 100, cellsalign: 'left', renderer: Common.percentageIconHeader },
      { text: 'New Net Salary', datafield: 'newNetSalary', editable: false, width: 100, cellsalign: 'left', renderer: Common.numberIconHeader},
      { text: 'New Net Salary Percetage', datafield: 'newNetSalaryPercentage', editable: false, width: 100, cellsalign: 'left', renderer: Common.percentageIconHeader },
