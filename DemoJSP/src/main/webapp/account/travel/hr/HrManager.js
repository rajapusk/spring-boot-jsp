var TravelHrManager = function(){
	...
	var popupConfig = [
		...
		{name: 'winL1ManagerRemarks', type: 'input', bind: 'l1ManagerRemarks', label: 'L1 Remarks', disabled: true},
		{name: 'winL2ManagerRemarks', type: 'input', bind: 'l2ManagerRemarks', label: 'L2 Remarks', disabled: true},
		{name: 'winHrRemarks', type: 'input', bind: 'hrRemarks', label: 'Hr Remarks'},
	...
	var source = {
        ...
        datafields: [
            ...
            {name: 'l2ManagerRemarks', type: 'string'},
	...
	var columns =  [
		...
		{ text: 'L2 Remarks', datafield: 'l2ManagerRemarks', width: 120, editable: false, cellsalign: 'left'},
        ...
        $("#btnSave").click(function () {
            if(selectedRows != null ) {				
                ...
                for(var sKey in selectedRows){
					...
					postData.push({id: row.rowData.id, hrApproved: row.rowData.approved, remarks: row.rowData.managerRemarks})
				}
	...
	var renderModel = function(){
        ...
        $("#winSave").click(function () {
            if (editRowId >= 0) {
				...
				var sManagerRemarks = $("#winHrRemarks").val();
                ...
                dataRecord.l2ManagerRemarks = sManagerRemarks;
                
                $('#dvPFAccount').jqxGrid('updaterow', rowID, dataRecord);
                $("#popupWindow").jqxWindow('hide'); 
                approveLoan([{ id: dataRecord.id, hrApproved: bApproved, remarks: sManagerRemarks}]);
            }
        });        
	}
	...
	var approveLoan = function(postData){
		$.ajax({
			type: 'PUT',
			url: Common.HOST + '/travel/hr/update', 
