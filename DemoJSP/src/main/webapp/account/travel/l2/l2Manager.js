var TravelL2Manager = function(){
	...
	var popupConfig = [
		...
		{name: 'winL2ManagerRemarks', type: 'input', bind: 'l2ManagerRemarks', label: 'L2 Remarks'},
        ...
        $("#btnSave").click(function () {
            if(selectedRows != null ) {				
                ...
                for(var sKey in selectedRows){
					...
					postData.push({id: row.rowData.id, l2Approved: row.rowData.approved, remarks: row.rowData.managerRemarks})
				}
	...
	var renderModel = function(){
        ...
        $("#winSave").click(function () {
            if (editRowId >= 0) {
				...
				var sManagerRemarks = $("#winL2ManagerRemarks").val();
                ...
                approveLoan([{ id: dataRecord.id, l2Approved: bApproved, remarks: sManagerRemarks}]);
            }
        });        
	}
	...
	var approveLoan = function(postData){
		$.ajax({
			type: 'PUT',
			url: Common.HOST + '/travel/l2/update', 
