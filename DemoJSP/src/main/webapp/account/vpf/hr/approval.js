var HRApproval = function(){
	...
	var columns =  [
      ...
      { text: 'Monthly Salary', datafield: 'monthlySalary', width: 100, editable: false, cellsalign: 'right' , renderer: Common.numberIconHeader},
      ...
      { text: 'Present VPF', datafield: 'presentVPF', width: 100, editable: false, cellsalign: 'right', renderer: Common.numberIconHeader },
      { text: 'Revised VPF', datafield: 'revisedVPF', editable: false, width: 100, cellsalign: 'right', renderer: Common.numberIconHeader },
