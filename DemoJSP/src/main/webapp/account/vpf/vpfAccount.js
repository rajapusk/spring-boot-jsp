var VPFAccount = function(){
	...
	var popupConfig = [
		...
		{name: 'winMonthlySALARY', type: 'input', bind: 'monthly_SALARY'},
		{name: 'winPrevNetSalary', type: 'input', bind: 'prevNetSalary'},
		{name: 'winPreNetSalaryPer', type: 'input', bind: 'netSalaryPercentage'},
		{name: 'winPresentvfp', type: 'input', bind: 'presentvfp'},
		{name: 'winRevisedvfp', type: 'input', bind: 'revisedvfp'},
	...
	var source = {
        ...
        datafields: [
            ...
            {name: 'presentvfp', type: 'number'},
            {name: 'revisedvfp', type: 'number'},
	...
	var columns =  [
      ...
      { text: 'Monthly Salary', datafield: 'monthly_SALARY', width: 100, editable: false, cellsalign: 'right' },
      ...
      { text: 'Present VPF', datafield: 'presentvfp', width: 100, editable: false, cellsalign: 'right' },
      { text: 'Revised VPF', datafield: 'revisedvfp', editable: false, width: 100, cellsalign: 'right' },
